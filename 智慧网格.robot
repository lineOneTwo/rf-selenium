...
#    sleep   5
#    input text       xpath://*[@id="appMain"]/div/div[2]/div/div/div[2]/form/div[1]/div/div[1]/input    检查
#    select frame     xpath:/html/body/div[1]/div/div[2]/section/div/div[2]/div/div/div[2]/form/div[2]/div/div/div/div/div[2]/iframe
#    input text       xpath://body    测试
#    unselect frame
#    sleep   2
#    CLICK BUTTON     xpath:/html/body/div[1]/div/div[2]/section/div/div[2]/div/div/div[3]/div/button[2]
#    # 查询
#    input text       xpath://*[@id="appMain"]/div/div[1]/div[2]/div/form/div[1]/div/div/input     检查
#    click element    xpath://*[@id="appMain"]/div/div[1]/div[2]/div/form/div[2]/div/button[1]/span
#    # 查看已读列表
#    click element    xpath://*[@id="appMain"]/div/div[1]/div[3]/div[3]/table/tbody/tr[1]/td[4]/div/button/span
#    Run Keyword And Continue On Failure    page_should_contain    公告标题：检查
#    # 选择层级
#    click element    xpath://*[@id="appMain"]/div/div[5]/div/div/div/div[2]/div[2]/div[1]/div/form/div[2]/div/div/div[1]/input
#    sleep    5
#    click element    xpath:/html/body/div[4]/div[1]/div/div[1]/ul/li/span
#    sleep    2
#    click element    xpath:/html/body/div[4]/div[1]/div[2]/div[1]/ul/li[1]/span
#    sleep    2
#    click element    xpath:/html/body/div[4]/div[1]/div[3]/div[1]/ul/li[1]/span
#    sleep    2
#    click element    xpath:/html/body/div[4]/div[1]/div[4]/div[1]/ul/li[1]/label/span[1]/span
#    sleep    2
#    click element    xpath://*[@id="appMain"]/div/div[5]/div/div/div/div[2]/div[2]/div[1]/div/form/div[3]/div/button[1]
#    sleep    2
#    Run Keyword And Continue On Failure    page_should_contain    平城区_开源街道_民悦社区_民悦社区第一网格
#    click element    xpath://*[@id="appMain"]/div/div[5]/div/div/div/div[2]/div[2]/div[1]/div/form/div[3]/div/button[2]/span
#    click element    xpath://*[@id="appMain"]/div/div[5]/div/div/div/div[3]/div/button/span
#    # 修改
#    click element    xpath://*[@id="appMain"]/div/div[1]/div[3]/div[4]/div[2]/table/tbody/tr[1]/td[5]/div/button[1]
#    select frame     xpath:/html/body/div[1]/div/div[2]/section/div/div[3]/div/div/div[2]/form/div[2]/div/div/div/div/div[2]/iframe
#    input text       xpath://body    修改内容
#    unselect frame
#    sleep   2
#    CLICK BUTTON     xpath:/html/body/div[1]/div/div[2]/section/div/div[3]/div/div/div[3]/div/button[2]
#    # 详情
#    click element    xpath://*[@id="appMain"]/div/div[1]/div[3]/div[4]/div[2]/table/tbody/tr[1]/td[5]/div/button[3]
#    Run Keyword And Continue On Failure    page_should_contain    修改内容
#    click element    xpath:/html/body/div[1]/div/div[2]/section/div/div[4]/div/div/div[3]/div/button
#    # 删除
#    click element    xpath://*[@id="appMain"]/div/div[1]/div[3]/div[4]/div[2]/table/tbody/tr[1]/td[5]/div/button[2]
#    click element    xpath:/html/body/div[4]/div/div[3]/button[2]
